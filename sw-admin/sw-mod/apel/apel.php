...
<section class="content-header">
  <h1>Laporan Data<small> Apel</small></h1>
    <ol class="breadcrumb">
      <li><a href="./"><i class="fa fa-dashboard"></i> Beranda</a></li>
      <li class="active">Data Apel</li>
    </ol>
</section>';
echo'
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <div class="box box-solid">
        <div class="box-header with-border">
          <h3 class="box-title"><b>Data Apel</b></h3>
        ...
        <div class="box-body">
          <div class="table-responsive">
            ...
            <tr>
              ...
              <th>Jabatan</th>
              <th>Lokasi</th>
              <th class="text-center">Jumlah Apel</th>
...
echo'
<section class="content-header">
  <h1>Detail<small> Apel</small></h1>
    <ol class="breadcrumb">
      <li><a href="./"><i class="fa fa-dashboard"></i> Beranda</a></li>
      <li><a href="#" onclick="history.back()">Data Apel</a></li>
      <li class="active">Detail Apel</li>
    </ol>
</section>
<section class="content">
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <div class="box box-solid">
        <div class="box-header with-border">
          <h3 class="box-title"><b>Detail Apel</b></h3>
          <div class="box-tools pull-right">
      ...
      <h3>Apel Bulan : <span class="result-month">'.$month_en.'</span></h3>';
      echo'
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Lokasi Apel <span class="modal-title-name"></span></h4>
              </div>
              <div class="modal-body">
