...
<section class="content-header">
  <h1>Data<small> Jam Apel</small></h1>
    <ol class="breadcrumb">
      <li><a href="./"><i class="fa fa-dashboard"></i> Beranda</a></li>
      <li class="active">Jam Apel</li>
    </ol>
</section>';
echo'
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <div class="box box-solid">
        <div class="box-header with-border">
          <h3 class="box-title"><b>Jam Apel</b></h3>
          <div class="box-tools pull-right">';
          $query="SELECT time_in,jam_apel_id FROM jam_apel order by jam_apel_id DESC";
            ...
            <table id="swdatatable" class="table table-bordered">
             ...
             while ($row= $result->fetch_assoc()) {
                ...
                <tr>
                  ...
                  <td class="text-center">'.$row['jam_apel_id'].'</td>
                  <td class="text-center">'.$row['time_in'].'</td>
                  <td class="text-center">
                    <div class="btn-group">';
                    if($level_user==1){
                    echo'
                      <a href="#modalEdit" class="btn btn-warning btn-sm enable-tooltip" title="Edit" data-toggle="modal"';?> onclick="getElementById('txtid').value='<?PHP echo $row['jam_apel_id'];?>';getElementById('txtin').value='<?PHP echo $row['time_in'];?>';"><i class="fa fa-pencil-square-o"></i></a>
                    <?php echo'
                    <buton data-id="'.epm_encode($row['jam_apel_id']).'" class="btn btn-sm btn-danger delete" title="Hapus"><i class="fa fa-trash-o"></i></button>';}
                  else{
                echo'
...
<div class="modal fade" id="modalAdd" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <form class="form validate add-apel">
...
<div class="modal fade" id="modalEdit" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <form class="form update-apel" method="post">
